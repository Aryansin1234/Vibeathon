              ...
              >
                ...
                >
                  ...
                  <CardHeader className="relative z-10">
                    ...
                    <CardTitle className="text-2xl sm:text-3xl font-bold transition-all duration-300">
                      <motion.span
                    ...
                    <CardDescription className="text-base sm:text-lg text-muted-foreground/80 group-hover:text-foreground/90 
